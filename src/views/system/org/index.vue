<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" row-key="id" border style="width: 100%" :tree-props="{ children: 'childBranch' }">
...
import { useOrgListApi, deleteBranch } from '@/api/orgs'

const state: IHooksOptions = reactive({
	apiList: useOrgListApi,
	apiDelete: deleteBranch,
	isPage: false
})
